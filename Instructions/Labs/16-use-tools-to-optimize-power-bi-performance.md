...
Para este laboratório, usaremos o Power BI Desktop, o Editor Tabular e o DAX Studio para otimizar um modelo semântico.

### Faça o download do arquivo inicial do Power BI

1. Navegue até [GitHub](https://github.com/MicrosoftLearning/mslearn-fabric/blob/main/Allfiles/Labs/16/Starter%20File%20-%20Use%20tools%20to%20optimize%20Power%20BI%20performance.pbix) e faça o download do arquivo **Início**. Esse é um arquivo .pbix que você abrirá no Power BI Desktop. Use o menu de elipses ... para obter a opção de download para baixar o arquivo .pbix bruto.
...
Nessa tarefa, você abrirá a solução pré-desenvolvida do Power BI Desktop que foi baixada anteriormente (arquivo **Usar ferramentas para otimizar o desempenho do Power BI.pbix**).

1. Abra o arquivo e, na janela **Salvar como**, salve o arquivo em um local que você se lembrará.
