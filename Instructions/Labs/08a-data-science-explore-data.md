---
lab:
  title: Criar e utilizar notebooks para explorar dados
...
1. Adicionar outra célula de código ao notebook. Em seguida, insira o seguinte código nessa célula e execute-o.
    ...
    A partir desse grafo, é possível observar o intervalo e a distribuição de `BMI` no conjunto de dados. Por exemplo, a maior parte de `BMI` está entre 23,2 e 29,2, e os dados estão distorcidos para a direita.
...
1. Use o ícone **+ Código** abaixo da saída da célula para adicionar uma nova célula de código ao notebook e insira o seguinte código.
    ...
    Podemos ver que, à medida que `BMI` aumenta, a variável de destino também aumenta, indicando uma relação linear positiva entre essas duas variáveis.
