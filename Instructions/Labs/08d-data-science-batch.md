...
1. Navegue até a página inicial do Microsoft Fabric em `https://app.fabric.microsoft.com` em um navegador.
1. Na página inicial do Microsoft Fabric, selecione **Ciência de Dados do Synapse**
